...
function Contact() {
    return (
        <div className="flex flex-col items-center w-full">
            ...
            <div className="lg:w-4/5 w-[94%] py-2">
                <iframe
            ...
            <div className="lg:w-4/5 w-[94%] py-6 bg-gray-200 flex justify-around">
                <div className="flex flex-col sm:flex-row p-4 w-[96%] bg-white gap-2">
                    <form className="form p-4 border border-gray-400 w-full sm:w-[50%] ">
                        <img
                            className=" w-[45%] py-2"
                            src={logo}
                            alt="Your Company"
                    ...
                    <div className="flex flex-col gap-2 bg-white border border-gray-500 rounded-md w-full sm:w-[50%] py-3 px-6">
                        <h2 className="pl-2 font-bold text-center mb-1  mt-4  ">
                            CONTACT US
                        </h2>
                        <div className="flex items-center gap-1 ">
                            <h2 className="sm:text-[14px] text-xs font-medium">
                                Address :
                            </h2>
