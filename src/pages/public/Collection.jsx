    ...
    return (
        <div className="w-full flex-col items-center flex">
            <div className="flex w-full justify-center py-5 bg-gray-200">
                <div className="lg:w-4/5 w-[95%] flex flex-col gap-1">
                    <h2>
                        {param.pathname
                            .replace("/", "")
                            ?.charAt(0)
            ...
            <div className="flex flex-col items-center lg:w-4/5 w-[90%]  ">
                <div className="flex items-center flex-col xs:flex-row justify-between p-3 border-2 shadow-md mt-7 mb-1 w-full">
                    <div className="flex flex-col gap-2 w-[100%] xs:w-[23%]">
                    ...
                    <div className="lg:w-[50%] sm:w-[40%] w-[100%] xs:w-[60%]">
                    ...
                    <div className=" flex-col gap-1 w-[16%] hidden sm:flex">
