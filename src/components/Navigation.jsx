...
function Navigation() {
    ...
    const isActives =
        "md:px-1 py-2 md:py-0 block md:pl-0 font-bold text-yellow-400 hover:text-red-400 text-sm lg:text-md";
    const notActive =
        "font-bold md:px-1 block py-2 md:py-0 md:pl-0  hover:text-yellow-400 text-sm lg:text-md";
    return (
